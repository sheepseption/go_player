...
class GnuGo():
    ...
    def __init__(self, size, seed=12345678):
        self._proc = subprocess.Popen(['gnugo', '--capture-all-dead', '--chinese-rules', '--monte-carlo', '--boardsize',str(size), '--mode', 'gtp', '--never-resign', '--seed', str(seed)], bufsize = 1, stdin=subprocess.PIPE,
